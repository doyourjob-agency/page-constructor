import{R as e,b as x,E as C}from"./iframe-BqOZKKc0.js";import{I as E}from"./sub-blocks-B3jHiR2u.js";import{C as h}from"./Content-DdYrt4da.js";import{L as i}from"./CardBase-95ZhlHhC.js";import{T as o}from"./Tag-DOwzDmsA.js";import{I as j}from"./IconWrapper-CFrVCfqR.js";import{u as l}from"./useUniqId-H5K74l96.js";import{g as N}from"./theme-AZDx78NF.js";const t=x("basic-card"),m=c=>{const{title:u,summary:g,text:p,icon:d,additionalInfo:y,links:f,list:v,buttons:T,iconPosition:q=E.Top,controlPosition:w="content",label:n,...b}=c,r=l(),a=l(),P=w==="footer",I=C(),s=N(d,I);return e.createElement(i,{className:t(),contentClassName:t("content"),...b,extraProps:{"aria-describedby":a,"aria-labelledby":r}},e.createElement(i.Content,null,n&&e.createElement("div",{className:t("labels")},Array.isArray(n)?n.map((k,A)=>e.createElement(o,{key:A,...k})):e.createElement(o,{...n})),e.createElement(j,{icon:s?{value:s,position:q}:void 0,className:t("wrapper")},e.createElement(h,{title:u,titleId:r,summary:g,text:p,textId:a,additionalInfo:y,links:f,list:v,buttons:T,size:"s",colSizes:{all:12,md:12},controlPosition:P?"bottom":"default"}))))},F=e.memo(m);m.__docgenInfo={description:"",methods:[],displayName:"BasicCard",props:{border:{required:!1,tsType:{name:"union",raw:"'shadow' | 'line' | 'none'",elements:[{name:"literal",value:"'shadow'"},{name:"literal",value:"'line'"},{name:"literal",value:"'none'"}]},description:""},analyticsEvents:{required:!1,tsType:{name:"union",raw:"AnalyticsEvent | AnalyticsEvent[]",elements:[{name:"intersection",raw:`T & {
    name: string;
    type?: string;
