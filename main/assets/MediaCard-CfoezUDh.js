import{b as o,R as e}from"./iframe-jz0ldN1p.js";import{L as a}from"./CardBase-Dj6rKRsu.js";import{T as t}from"./Tag-D8DZDIm5.js";import{M as g}from"./Media-DJHk47pu.js";const r=o("MediaCard"),d=({border:s,analyticsEvents:i,label:n,...l})=>e.createElement(a,{className:r(),bodyClassName:r("body"),border:s,analyticsEvents:i},e.createElement(a.Content,null,n&&e.createElement("div",{className:r("labels")},Array.isArray(n)?n.map((u,m)=>e.createElement(t,{key:m,...u})):e.createElement(t,{...n})),e.createElement(g,{...l})));d.__docgenInfo={description:"",methods:[],displayName:"MediaCard",props:{animated:{required:!1,tsType:{name:"boolean"},description:""},color:{required:!1,tsType:{name:"string"},description:""},videoMicrodata:{required:!1,tsType:{name:"signature",type:"object",raw:`{
    name?: string;
    description?: string;
    duration?: string;
    uploadDate?: string;
