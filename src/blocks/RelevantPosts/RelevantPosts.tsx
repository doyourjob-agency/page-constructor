...
export const RelevantPosts = ({
    ...
    const findedPinnedPost = useMemo(
        () => filteredPosts.find((item) => item.slug === pinnedPost),
        [filteredPosts, pinnedPost],
    );

    const finishPosts = useMemo(
        () => filteredPosts.filter((item) => item.slug !== pinnedPost),
        [filteredPosts, pinnedPost],
    );
