...
`theme: 'action' | 'clear' | 'link' | 'normal' | 'pseudo' | 'raised' | 'websearch' | 'normal-dark' | 'dark-grey' | 'github' | 'apple-podcasts' | 'spotify' | 'youtube' | 'app-store' | 'google-play' | 'scale' | 'monochrome' | 'violet'` — Button's look and feel.
