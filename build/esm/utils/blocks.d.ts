import { ConstructorBlock, CustomConfig, PCShareSocialNetwork, TitleTextSize, VisibilityProp } from '../models';
...
export declare const getBlockVisibilityClasses: (visibility?: VisibilityProp) => Record<string, boolean>;
