...
const LayoutItem = (_a) => {
    var { title, afterTitle, rightSpace = true } = _a, _b = _a.content, { links } = _b, content = tslib_1.__rest(_b, ["links"]), { metaInfo, media, border, fullscreen, icon, className, analyticsEvents, controlPosition = 'content' } = _a;
