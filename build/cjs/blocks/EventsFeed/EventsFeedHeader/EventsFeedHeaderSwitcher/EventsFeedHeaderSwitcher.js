...
exports.EventsFeedHeaderSwitcher = void 0;
const tslib_1 = require("tslib");
const react_1 = tslib_1.__importStar(require("react"));
const uikit_1 = require("@gravity-ui/uikit");
const utils_1 = require("../../../../utils");
const CloseIcon_1 = require("../CloseIcon");
const DropdownArrowIcon_1 = require("../DropdownArrowIcon");
const b = (0, utils_1.block)('events-feed-header-switcher');
const ICON_SIZE = 12;
const CLEAR_ICON_SIZE = 11;
const EventsFeedHeaderSwitcher = ({ initial, defaultLabel, list, onClick, controlRef, onKeyDown, open, renderClear, popupId, activeIndex, }) => {
...
exports.EventsFeedHeaderSwitcher = EventsFeedHeaderSwitcher;
exports.default = exports.EventsFeedHeaderSwitcher;
