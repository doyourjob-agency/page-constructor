...
const EventsFeedHeader = ({ title, image }) => {
    return (react_1.default.createElement("div", { className: b() },
        react_1.default.createElement(grid_1.Grid, { className: b('content') },
            ...
            react_1.default.createElement(EventsFeedHeaderControls_1.default, { title: title }))));
};
exports.EventsFeedHeader = EventsFeedHeader;
exports.default = react_1.default.memo(exports.EventsFeedHeader);
