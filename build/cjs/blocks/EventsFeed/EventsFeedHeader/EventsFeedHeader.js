...
const EventsFeedHeader = ({ title, countries, types, image, handleLoadData, queryParams, }) => (react_1.default.createElement("div", { className: b() },
    react_1.default.createElement(grid_1.Grid, { className: b('content') },
        ...
        react_1.default.createElement(EventsFeedHeaderControls_1.default, { title: title, countries: countries, types: types, handleLoadData: handleLoadData, queryParams: queryParams }))));
