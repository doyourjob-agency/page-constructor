...
const BlockBase = (props) => {
    ...
    return (react_1.default.createElement(grid_1.Col, { className: b({ ['reset-paddings']: resetPaddings, indentTop: top, indentBottom: bottom }, className), hidden: hidden, visible: visible, reset: true, qa: qa },
