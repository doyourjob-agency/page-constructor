...
exports.getBlockVisibilityClasses = exports.getQaAttrubutes = exports.getShareLink = exports.getHeaderBlock = exports.getOrderedBlocks = exports.getCustomTypes = exports.getCustomItems = exports.getBlockKey = exports.hasBlockTag = exports.getHeaderTag = void 0;
...
const getBlockVisibilityClasses = (visibility) => {
    if (!visibility)
        return {};
    ...
    return visibleBreakpoints.reduce((acc, bp) => (Object.assign(Object.assign({}, acc), { [`visible-${bp}`]: true })), { hidden: true });
};
exports.getBlockVisibilityClasses = getBlockVisibilityClasses;
